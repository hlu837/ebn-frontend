...
/// Public (not file-private) so other agent screens — e.g. the dashboard's
/// quick-access language icon — can read/save the same language values
...
AppLanguage languageFromString(String value) =>
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _language = languageFromString(settings.language);
                ...
                _SectionCard(
                  ...
                  children: [
                    ...
                    Consumer<ThemeController>(
                      builder: (context, themeController, _) => _NavRow(
