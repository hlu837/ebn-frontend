...
import 'admin_pending_property_owners_screen.dart';
      ...
      drawer: AdminDrawer(
        ...
        actions: AdminDrawerActions(
          onApprovalsQueue: () => Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => AdminSellRequestsScreen(token: widget.user.token ?? ''),
          )),
          ...
          onPendingPropertyOwners: () =>
              Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => AdminPendingPropertyOwnersScreen(token: widget.user.token ?? ''),
          )),
              ...
              itemBuilder: (context, index) => AssetListCard(
                ...
                onActionPressed: () async {
                  final result =
                    ...
                    builder: (_) => AdminListingDetailScreen(
                      asset: _assets[index],
                      token: widget.user.token ?? '',
                    ),
                  ));
