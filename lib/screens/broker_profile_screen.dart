...
class _BrokerProfileScreenState extends State<BrokerProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Every category the app supports, in enum order — lets a visitor
    // browse by any category from this broker's profile even if the
    // broker doesn't currently have an active listing there (selecting
    // one just shows the "No listings yet" empty state for it).
    final availableCategories = AssetCategorySlug.values.toList();
...
/// Horizontal, scrollable "All" + category chips — every app category is
/// offered regardless of what this broker currently has listed, so a
/// visitor can browse by category and see the empty state for any that
/// don't have active listings yet.
