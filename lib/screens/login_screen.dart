...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // Catch the session the moment a real token exists, so it survives
      // an app restart until an explicit logout clears it again.
      ...
      if (e.message.contains("Couldn't reach the server")) {
        NetworkAlert.show(context);
      } else {
