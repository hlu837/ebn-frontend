...
class _OwnerContactSectionState extends State<_OwnerContactSection> {
  ...
  Future<void> _rentNow() => _send(PropertyRequestType.rentNow, 'Rent this property',
      hint: "I'd like to rent this property.", defaultText: "I'd like to rent this property.");

  Future<void> _send(PropertyRequestType type, String dialogTitle, {required String hint, String? defaultText}) async {
    final message = await _composeMessage(context, title: dialogTitle, hint: hint, initialText: defaultText);
  ...
  Future<String?> _composeMessage(BuildContext context, {required String title, required String hint, String? initialText}) {
