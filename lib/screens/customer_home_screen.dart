...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  List<Asset> get _filteredAssets {
    ...
    // The "Top picks / Nearby / Certified / Free Items" strip is a pure
    // view toggle, not a second filter — all four tabs show the same
    // underlying list (search + category only). It used to additionally
    // filter Nearby down to Addis Ababa and Certified down to active-only
    // listings, which made the tabs show different (often emptier) data
    // than "Top picks" for no visible reason.
