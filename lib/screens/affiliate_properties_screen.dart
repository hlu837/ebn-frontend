...
class _AffiliatePropertiesScreenState extends State<AffiliatePropertiesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Every category, not just the ones the currently-loaded assets happen
    // to have active listings in — otherwise a category with zero live
    // listings right now (e.g. Machinery) never even shows up as a filter
    // option for the affiliate to check back on later.
    final categories = AssetCategorySlug.values;
