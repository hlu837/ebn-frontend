...
class _CategoryListingScreenState extends State<CategoryListingScreen>
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.search_rounded,
                                size: 20, color: LandingColors.muted),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (_loading)
                    ...
                    _buildAssetGrid(context, assets),
                ],
              ),
            ),
          ],
  ...
  Widget _buildAssetGrid(BuildContext context, List<Asset> assets) {
    final left = <Asset>[];
    final right = <Asset>[];
  ...
  Widget _buildCard(BuildContext context, Asset asset) {
    return AssetListCard(
      ...
      brokerInitials: _brokerFor(asset)?.initials,
      onBrokerAvatarTap: () {
        final broker = _brokerFor(asset);
        if (broker == null) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
                content: Text("No agent info for this listing yet.")),
          );
          return;
        }
