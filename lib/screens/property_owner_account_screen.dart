...
import 'owner_bank_accounts_screen.dart';
import 'property_owner_closed_deals_screen.dart';
import 'property_owner_listings_screen.dart';
import 'property_owner_maintenance_requests_screen.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              _MenuTile(
                ...
                subtitle: 'Issues tenants have reported — accept or decline',
                onTap: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => PropertyOwnerMaintenanceRequestsScreen(user: user),
                )),
              ),
              ...
              _MenuTile(
                ...
                label: 'Bank Accounts',
                subtitle: 'Accounts tenants pay rent into',
                onTap: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => OwnerBankAccountsScreen(user: user),
                )),
              ),
              const SizedBox(height: 18),
