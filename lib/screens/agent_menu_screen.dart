...
class AgentMenuScreen extends StatelessWidget {
  ...
  /// Opens the broker's own full property list (any status), with an
  /// "Active" filter — distinct from [onPropertyManagement], which is the
  /// sell-request claiming workflow, not the broker's posted listings.
      ...
      child: ListView(
        ...
        children: [
          ...
          _MenuSection(title: 'Business', items: [
            ...
            _MenuEntry(Icons.home_work_outlined, 'My Listings', onMyListings),
