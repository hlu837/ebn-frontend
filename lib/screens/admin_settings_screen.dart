...
import 'admin_maintenance_assignments_screen.dart';
import 'admin_specialist_wallets_screen.dart';
            ...
            _SettingsSection(
              ...
              items: [
                ...
                _SettingsItem(
                  ...
                  onTap: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => AdminServiceProvidersScreen(token: token),
                  )),
                ),
                _SettingsItem(
                  ...
                  onTap: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => AdminMaintenanceAssignmentsScreen(token: token),
                  )),
                ),
                _SettingsItem(
                  icon: Icons.account_balance_wallet_outlined,
                  label: 'Specialist Wallets',
                  onTap: () => Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => AdminSpecialistWalletsScreen(token: token),
                  )),
                ),
                _SettingsItem(
