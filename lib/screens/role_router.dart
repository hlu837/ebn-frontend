...
import 'property_owner_home_screen.dart';
...
/// five (six, counting Admin) roles land:
///
...
///   Property Owner → Dashboard/Inbox/Post/Review/Account (PropertyOwnerHomeScreen)
...
Widget dashboardForRole(UserRole role, AppUser user) {
  return switch (role) {
    ...
    UserRole.propertyOwner => PropertyOwnerHomeScreen(user: user),
  };
}
