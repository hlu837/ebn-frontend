...
/// fixed 190px height. The image is cropped with [BoxFit.cover] to fill
...
class CompanyAdCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final image = imageUrl.isEmpty ? null : dataUrlOrNetworkImage(imageUrl);
    return Container(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            hasLink ? Icons.open_in_new_rounded : Icons.zoom_in_rounded,
                            color: Colors.white,
                            size: 14,
                          ),
