...
enum AppNotificationKind { newDispatch, chatMessage, payout, rentalAgreement, system }
...
AppNotificationKind _kindFromApi(String? raw) {
  switch (raw) {
    ...
    case 'rental_agreement':
      return AppNotificationKind.rentalAgreement;
    default:
...
bool shouldAutoOpenDispatchAlert(AppNotification notification) {
  return notification.kind == AppNotificationKind.newDispatch &&
