...
enum UserRole { user, affiliater, agent, investor, propertyOwner, admin }
...
extension UserRoleX on UserRole {
  ...
  String get pitchLine => switch (this) {
        ...
        UserRole.propertyOwner => 'List your property for rent and manage requests yourself — no physical visits needed.',
  ...
  IconData get pitchIcon => switch (this) {
        ...
        UserRole.propertyOwner => Icons.house_rounded,
  ...
  String get signupHeadline => switch (this) {
        ...
        UserRole.propertyOwner => 'Join as a Property Owner',
  ...
  String get signupSubtitle => switch (this) {
        ...
        UserRole.propertyOwner => 'Post your property for rent and handle requests directly — no fee, no site visit.',
  ...
  String get signinHeadline => switch (this) {
        ...
        UserRole.propertyOwner => 'Property Owner sign in',
  ...
  String get signinSubtitle => switch (this) {
        ...
        UserRole.propertyOwner => 'Sign in to manage your listings and rental requests.',
