...
class AgentProfileData {
  ...
  /// A more specific location within [city] (neighborhood/sub-city, e.g.
  /// "Jemo") — shown on the public broker profile and map pin, separate
  /// from the broad city name so customers can tell brokers in the same
  /// city apart.
