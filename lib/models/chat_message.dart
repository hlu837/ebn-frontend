...
class ChatMessage {
  ...
  /// Optional typed link to another record, set only on system-generated
  /// messages (see backend migration 093). Currently just
  /// [kindRentalAgreement], whose [relatedId] is the rental agreement's id
  /// — the chat screen turns it into an "Open agreement" button.
  final String? kind;
  final String? relatedId;

  /// Structured facts for the card the chat screen draws for this message
  /// (for a rental agreement: monthlyRent, advanceMonths, advanceAmount,
  /// depositAmount, totalDue, currency, leaseTermMonths, windowHours).
  /// Null on ordinary messages — those just show [body].
  final Map<String, dynamic>? meta;

  static const String kindRentalAgreement = 'rental_agreement';
